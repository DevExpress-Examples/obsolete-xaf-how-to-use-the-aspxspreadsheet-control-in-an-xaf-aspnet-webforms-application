...
Namespace SpreadsheetExample.Web
	...
	Partial Public Class SpreadsheetExampleAspNetApplication
		Inherits WebApplication

		Private module1 As DevExpress.ExpressApp.SystemModule.SystemModule
		Private module2 As DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule
		Private module3 As SpreadsheetExample.Module.SpreadsheetExampleModule
		Private module4 As SpreadsheetExample.Module.Web.SpreadsheetExampleAspNetModule
		...
		End Function
		Private Sub SpreadsheetExampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
...
#End If
		...
		Private Sub InitializeComponent()
			...
			Me.module3 = New SpreadsheetExample.Module.SpreadsheetExampleModule()
			Me.module4 = New SpreadsheetExample.Module.Web.SpreadsheetExampleAspNetModule()
			...
			' 
			Me.ApplicationName = "SpreadsheetExample"
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.SpreadsheetExampleAspNetApplication_DatabaseVersionMismatch)
